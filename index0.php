...
<body style="background:#ffffff;">
    <div style="background-repeat: repeat;height:100%;">

  <div class="container-fluid">
    <div class="row m-t-xl ">
      <div class="col-sm-6 m-t-lg">

        <h4 class="text-center" style=""><span style="font-weight:lighter">Your flight is booked.</span></h4>
          ...
          <section class="strap">
            <div class="box">
              <div class="passenger">
                ...
                <strong>P. Sherman</strong>
              </div>
              <div class="date">
                <small>Date</small>
                <strong>Mon, 20 May 2018</strong>
              </div>
            </div>
            <svg class="qrcode">
      ...
      <div class="col-sm-6">
        <img style="max-height:400px;" class="img-fluid" src="img/tray.png" />
        <h5>
        <a href="page1.html">
          <img style="height: 100px;object-fit:contain;" src="img/logo-btn.png"/>

        </a>
        </h5>
        <!-- <h3 class="font-thin">Click the balloon to make your complimentary menu choices.</h3> -->
        <h6>
        Customize your complimentary meals</h6><h6>
        Lower your carbon footprint</h6><h6>
        Earn miles!
      </h6>
      </div>
    </div>
